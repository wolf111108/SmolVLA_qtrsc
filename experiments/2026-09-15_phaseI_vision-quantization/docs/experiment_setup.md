...
```bash
# baseline
python main.py --config experiments/2026-09-15_phaseI_vision-quantization/configs/xxx.yaml

# 批量（如有）
bash experiments/2026-09-15_phaseI_vision-quantization/scripts/run_all.sh
```
...
|---|---|---|
| xxx.yaml | outputs/2026-09-15_phaseI_vision-quantization/xxx/ | pending / done / failed |
