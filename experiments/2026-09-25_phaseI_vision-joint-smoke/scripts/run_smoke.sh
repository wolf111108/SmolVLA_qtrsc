...
EXP=experiments/2026-09-25_phaseI_vision-joint-smoke
OUT=outputs/2026-09-25_phaseI_vision-joint-smoke
CFG="$EXP/configs/vision_joint_fp8.yaml"
# Preserve previous evidence; rerun only after archiving these experiment outputs/scales.
if [[ -e "$OUT/run.log" || -e "$OUT/preflight.json" || -d scales/2026-09-25_phaseI_vision-joint-smoke/vision_joint_fp8 ]]; then
