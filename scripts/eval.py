...
# =============================================================================
# VLA_TCS2 model transform hook
# =============================================================================
def apply_model_transform(policy, cfg):
    """
    Hook for modifying the loaded policy before evaluation.

    Current behavior:
        Identity transform. The policy is returned unchanged.
...
def eval_main(cfg: EvalPipelineConfig):
    ...
    # =========================================================================
    # VLA_TCS2: transform the fully loaded policy before evaluation
    # =========================================================================
